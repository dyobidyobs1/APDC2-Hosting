...
$conn->close();
 ...
 <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
   <head>
     <title>Delete Patients | Apigo - Pedracio Dental Clinic</title>
   </head>
   <body>
    ...
    <b><a href="admin_apdc_patients.php"><img src="patient.png"/> Patients</a></b>
     ...
     <h2 class="h2" align="left">Delete Patient Profile
     </h2>
<form method="POST" action="admin_apdc_patients_finaldeletepatient.php">
    ...
    <tr>
      <td>
        <input type=text name=abirthday value="<?php echo $abirthday;?>" readonly>
    <tr>
      <th>
        Contact No.
    <tr>
