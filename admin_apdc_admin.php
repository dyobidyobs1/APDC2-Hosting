...
<script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
  <head>
    <title>Admin | Apigo - Pedracio Dental Clinic</title>
  </head>
  <body>
    ...
    <h2 class="h2" align="left">Admin
    <button2>&nbsp<img src="add.png">&nbsp<b style='font-size:15px;color:white;'><a href="admin_apdc_admin_add.php" style="color:white;text-decoration:none;"> Add Admin  &nbsp</b></a></button2>
...
if(!empty($result)){
  ...
  while($row=$result->fetch_assoc()){
    ...
    echo"<td><a href='admin_apdc_admin_edit.php?id=".$row['id']."'><img src=\"edit.png\"></a>&nbsp&nbsp&nbsp
             <a href='admin_apdc_admin_delete.php?id=".$row['id']."'><img src=\"trash.png\"></a>";
  }
