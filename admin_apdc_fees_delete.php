...
$conn->close();
 ...
 <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
   <head>
     <title>Delete Services & Fees| Apigo - Pedracio Dental Clinic</title>
   </head>
   <body>
     ...
     <h2 class="h2" align="left">Delete Services & Fees
     </h2>
<form method="POST" action="admin_apdc_fees_finaldeletefees.php">
    <table class='styled-table'>
      ...
      <tr>
        <td>
          <input type=text name=aservices value="<?php echo $aservices;?>" readonly>
    <tr>
      <th>
        Fee
    <tr>
      <td>
        <input type=text name=afees value="<?php echo $afees;?>" readonly>
    <tr>
        <th colspan="2">
