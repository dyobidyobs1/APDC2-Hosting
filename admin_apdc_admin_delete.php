...
$conn->close();
 ...
 <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
   <head>
     <title>Delete Admin | Apigo - Pedracio Dental Clinic</title>
   </head>
   <body>
     ...
     <h2 class="h2" align="left">Delete Admin Profile
     </h2>
<form method="POST" action="admin_apdc_admin_finaldeleteadmin.php">
