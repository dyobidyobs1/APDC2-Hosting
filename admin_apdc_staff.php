...
<html>
  ...
  <link rel="stylesheet" href="admin_apdc_staff.css">
  <link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700,800" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
  <head>
    <title>Staff | Apigo - Pedracio Dental Clinic</title>
  </head>
  <body>
    <form method="POST" action="admin_apdc_staff.php">

      <!-- Navigation -->
      <nav class="topnav" style="max-width:100%">
      <span style="cursor:pointer" onclick="openNav()">&#9776; </span>

      <a href="admin_apdc_staff.php" style="color:white; font-size: 25px;"></a>
    ...
    <h2 class="h2" align="left">Staff
      <button2>&nbsp<img src="add.png">&nbsp<b style='font-size:15px;color:white;'><a href="admin_apdc_staff_add.php" style="color:white;text-decoration:none;"> Add Staff  &nbsp</b></a></button2>
...
if(isset($_POST['submit'])){
  ...
  if($search != NULL){
    ...
    $sql = "Select * from tbl_staffs where
    name LIKE '%$search%' or
...
if(!empty($result)){
  ...
  while($row=$result->fetch_assoc()){
    ...
    echo"<td><a href='admin_apdc_staff_edit.php?id=".$row['id']."'><img src=\"edit.png\"></a>&nbsp&nbsp&nbsp
    <a href='admin_apdc_staff_delete.php?id=".$row['id']."'><img src=\"trash.png\"></a>";
  }
