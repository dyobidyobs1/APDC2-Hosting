...
<html>
  ...
  <body>
    ...
    <div style="width: 100%;">
        ...
        padding-top:50px;
        padding-bottom:50px;"> 
        <p align="left"><b>ORAL PROPHYLAXIS (TEETH CLEANING)</b></p>
        <p align="left">A dental prophylaxis is a cleaning procedure performed to thoroughly clean the teeth.  Prophylaxis is an important dental treatment for halting the progression of periodontal disease and gingivitis.
            
        <p align="left"><b>PAINLESS ULTRASONIC</b></p>
        <p align="left">Oral prophylaxis  Deep cleaning with air flow removes plaque and tartar both above and below the gum and much of the food and stains caused by smoking. It is an easy, routine and painless treatment, with immediate visible results, and it’s one of the most requested procedures, especially airflow cleaning for colouring and plaque.
            
        <p align="left"><b>ROOT PLANNING AND SCALING</b></p>
        <p align="left">Scaling and root planning is a deep cleaning below the gumline used to treat gum disease. Dental scaling occurs with manual hand instruments, ultrasonic instruments or both. Root planning involves detailed scaling of the root surface to decrease inflammation of the gum tissue. The dentist scales the root surface to smooth out rough target areas, eliminating plaque and biofilm development.

        <p align="left"><b>DENTAL RESTORATION</b></p>
        <p align="left">A dental restoration or dental filling is a dental restorative material used to restore the function, integrity and morphology of missing tooth structure. The structural loss typically results from caries or external trauma.

        <p align="left"><b>ENDODONTICS</b></p>
        <p align="left">Treatment of diseases of the dental pulp, usually by removal ofthe nerve and other tissue of the pulp cavity and its replacement with suitable filling material to save the tooth and prevent complications.
        ...
        padding-top:50px;
        "> 
    <img src="services_generaldentistry.png" class="homeimg3">
        </div>
    </div>
