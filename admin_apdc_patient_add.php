...
$conn->close();
 ...
 <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
   <head>
     <title>Add Patients | Apigo - Pedracio Dental Clinic</title>
   </head>
   <body>
    ...
    <b><a href="admin_apdc_patients.php"><img src="patient.png"/> Patients</a></b>
     ...
     <h2 class="h2" align="left">Add Patient Profile
     </h2>
<form method="POST" action="admin_apdc_patients_finaladdpatient.php">
    ...
    <tr>
      <td>
        <input type=text name=aaddress value="">
    <tr>
      <th>
        Birthdate
    <tr>
      <td>
        <input type=text name=abirthday value="">
    <tr>
      <th>
        Contact No.
    <tr>
      <td>
        <input type=text name=acontact value="">
    <tr>
      <th>
        Email
    <tr>
    ...
    <tr>
        <th colspan="2">
        <a href="admin_apdc_patients.php" id="a2">Cancel</a>
